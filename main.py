...
# CONFIGURATION
# ---------------------------
EXCEL_PATH = r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\Excel Data\Master Product List.xlsx"
FIXED_SLIDE_IMAGES = [
    r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\Photos\2nd page.jpg",
    r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\Photos\3rd Page.jpg"
]
LAST_SLIDE_IMAGE = [ r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\Photos\Last Page.jpg" ]
OUTPUT_PATH = r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\Presentations\final presentation.pptx"
IMAGE_FOLDER = r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\ERP Image Export 14-05-2025"
LOGO_PATH = r"C:\Users\Divyansh\OneDrive - Casa Mia LLC\Desktop\SPec Presentation Generator\Photos\logo.png"


TEMPLATES_PER_PRODUCT_COUNT = {
    1: 4,   # 4 templates for 1 product
    2: 3,   # 3 templates for 2 products
    3: 3,   # 3 templates for 3 products
    4: 2,   # 2 templates for 4 products
    5: 1,   # 1 template for 5 products
    6: 1,   # 1 template for 6 products
    7: 1,   # 1 template for 7 products
}
...
# this was for title slide 
#  def add_title_slide(prs, title_text):
#     slide_layout = prs.slide_layouts[0]  # Title Slide
#     slide = prs.slides.add_slide(slide_layout)
#     slide.shapes.title.text = title_text
#     slide.placeholders[1].text = "Auto-generated Product Specification"
...
def main():
    df = load_excel_data()
    # prs = Presentation(FIXED_SLIDES_PATH)  # Load the 3 fixed intro slides as the starting point
    ...
    # print(f"📏 Slide Size → Width: {slide_width:.2f} inches, Height: {slide_height:.2f} inches")
    # return  # Prevent rest of script from running

    
    # # 🔍 DEBUG: Print all available layout names
    ...
    # # NEW: Create dynamic output path based on title
    # safe_title = "".join(c for c in title if c.isalnum() or c in " _-").strip()
    # output_path = os.path.join(
    #     os.path.dirname(OUTPUT_PATH), f"{safe_title} - final presentation.pptx"
    # )

    # # this was for title slide add_title_slide(prs, title)

    # # Step 2: Insert fixed slides
    # # insert_fixed_slides(prs)

    # # Step 3: Add product slides interactively
    # while True:
    #     page_title = input("\nEnter the title for this product page: ")
    #     product_count = int(input("How many products on this slide? (1/2/3/4/5/6/7 or 1 to 7): "))
        
    #     # print(f"Product 3:- Template 1: Straight Template 2: Downwards Template 3: Upwards")
    #     # template_number = int(input("Choose layout template (1/2/3): "))

    #     # Figure out how many templates are available
    ...
    #     # Show template options dynamically
    #     if template_count == 1:
